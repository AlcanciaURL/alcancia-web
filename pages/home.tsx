                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-[white] rounded-lg border-dashed shadow-xl border-2 border-[#329F5B] shadow-[6px_9px_5px_0px_#a0aec0]">
                            <div className="grid grid-cols-1 p-2 gap-3 place-items-center">
                                ...
                                <div>
                                    <span>Nombre de usuario</span>
                                    <button className="ml-5 text-xs text-[#329F5B] hover:bg-[#329F5B] hover:text-white rounded-lg p-2">Editar</button>
                                </div>
                                ...
                                <div>
                                    <button className="bg-[#D9D9D9] p-2 mt-3 rounded-lg  hover:bg-[red] hover:text-white align-middle text-center">Eliminar usuario</button>
                                </div>
